...
with gr.Blocks(title="CompSoft") as demo:
    gr.Markdown("# Magyar Telekom LLM Demo")
...
#demo.launch()
demo.launch(share=True, share_server_address="gradio.componentsoft.ai:7000", share_server_protocol="https", auth=("Telekom", "Könyveskrt36"), max_threads=20, show_error=True, favicon_path="/home/rconsole/GIT/AI-434/source/labfiles/data/favicon.ico", state_session_capacity=20)
